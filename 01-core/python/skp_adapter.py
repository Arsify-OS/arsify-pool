...
Diselesaikan: 4 mismatch yang ditemukan Hermes:
  ...
  4. Router path: /opt/arsify vs /root/.hermes
...
DB_CANDIDATES = [
    ...
    "/data/shared_knowledge_pool.db",            # direct (hermes production)
    "/root/.hermes/shared_knowledge_pool.db",    # hermes native path
    "/root/.hermes/knowledge.db",
    "/opt/hermes-cognitive/data/knowledge.db",
]
...
def detect_key_format(conn: sqlite3.Connection, table: str) -> dict:
    ...
    # Format B (hermes production): senator-akademisi/execution/XXXXX
    # Format C (hermes lain): hermes/senator/akademisi/XXXXX
    ...
    format_c = sum(1 for k in keys if k.startswith("hermes/senator"))
    ...
    if format_b > format_a and format_b > format_c:
        ...
        # Format C
        return {
            "akademisi":   ["hermes/senator/akademisi/", "akademisi/"],
            "bisnis":      ["hermes/senator/bisnis/", "bisnis/"],
            "komunitas":   ["hermes/senator/komunitas/", "komunitas/"],
            "pemerintah":  ["hermes/senator/pemerintah/", "pemerintah/"],
            "media":       ["hermes/senator/media/", "media/"],
            "write_prefix": {
