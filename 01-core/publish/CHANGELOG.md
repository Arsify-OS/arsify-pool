...
- Upshalter Cognitive Engine integration: `/v1/portsocket` returns pipeline metadata, not raw LLM text. Using direct OpenRouter until Upshalter L3/L4 pipeline stabilizes.
